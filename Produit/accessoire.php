            ...
            <body>
                ...
                <form method="post">
                    <select id="selectProduct" name="selectProduct">
                        ...
                        $sql = "SELECT nomDitom, Reference FROM catalogueProduit WHERE categorie = 'accessoire' ORDER BY nomditom ASC";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "Aucun accessoire trouvé dans la base de données.";
                        }
                        ?>
                    </select>
                        ...
                        if (isset($_POST['selectProduct'])) {
                            ...
                            if ($result && $result->num_rows > 0) {
                                ...
                                if(isset($row['nomFournisseur'])) { 
                                    echo "<p>Fournisseur: " . $row['nomFournisseur'] . "</p>";
                                }
