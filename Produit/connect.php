            ...
            <body>
                ...
                <form method="post">
                    <select id="selectProduct" name="selectProduct">
                        <?php
                        include 'config.php'; // fichier de configuration pour la connexion

                        // Récupération des données de la table catalogueProduit avec catégorie "connectique"
                        $sql = "SELECT nomDitom, Reference FROM catalogueProduit WHERE categorie = 'connectique' ORDER BY nomditom ASC";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "Aucun connectique trouvé dans la base de données.";
                        }
                        ?>
                    </select>
