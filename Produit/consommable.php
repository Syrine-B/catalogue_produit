            ...
            <body>
                ...
                <form method="post">
                    <select id="selectProduct" name="selectProduct">
                        ...
                        $sql = "SELECT nomDitom, Reference FROM catalogueProduit WHERE categorie = 'consommable' ORDER BY nomditom ASC";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "Aucun consommable trouvé dans la base de données.";
                        }
                        ?>
                    </select>
