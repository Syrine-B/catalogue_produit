            ...
            <body>
                ...
                <form method="post">
                    <select id="selectProduct" name="selectProduct">
                        <?php
                        include 'config.php'; 
                        $sql = "SELECT nomDitom, Reference FROM catalogueProduit WHERE categorie = 'ordinateur' ORDER BY nomditom ASC ";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "Aucun ordinateur trouvé dans la base de données.";
                        }
                        ?>
                    </select>
